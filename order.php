        ...
        <div class="col-md-10 col-sm-9">
            <div class="table-responsive">
                ...
                <table class="table table-sm">
                    ...
                    <tbody>
                    <?php
                    $sqlOrder = "SELECT `orders`.`orderId`,`orders`.`totalPrice`,`orders`.`created_at`,`orders`.`updated_at`, `payment`.`paymentMethod`
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="border-0 align-middle"><?php echo $arrOrders[$i]["paymentMethod"] ?></td>
                            ...
                            <td class="border-0 align-middle"><?php echo $arrOrders[$i]["totalPrice"] ?> $NTD</td>
