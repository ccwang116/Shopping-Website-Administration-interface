...
$sql.= "`paymentMethod` = ? ,";
$arrParam[] = $_POST['paymentMethod'];
$sql.= "`paymentAllowed` = ? ";
$arrParam[] = $_POST['paymentAllowed'];
...
if( $stmt->rowCount()> 0 ){
    header("Refresh: 0; url=./paymentType.php");
    ...
    header("Refresh: 0; url=./editPaymentType.php?paymentId={$_POST['paymentId']}");
