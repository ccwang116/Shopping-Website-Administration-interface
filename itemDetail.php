            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    ...
                    <form name="cartForm" id="cartForm" method="POST" action="./addCart.php">
                        <label>數量: </label>
                        <input type="text" name="cartQty" id="cartQty" value="1" maxlength="5"><br>
                        <button type="button" class="btn btn-outline-dark btn-lg" id="btn_addCart" data-item-id="<?php echo $_GET['itemId'] ?>">加入購物車</button>
                        <button type="button" class="btn btn-outline-dark btn-lg" id="btn_addItemTracking" data-item-id="<?php echo $_GET['itemId'] ?>">追蹤此商品</button>
